...
/** Read-side filtering, tenant guards, response mapping and supplier export. */
@Service
public class SupplierQueryService {
    ...
    SupplierEntity requireSupplier(Long id) {
        AuditMetadata audit = auditMetadataFactory.current();
    ...
    private LambdaQueryWrapper<SupplierEntity> buildListQuery(
            Long companyId,
            Long accountBookId,
            String keyword,
            String status,
