...
/**
 * Read-side filtering, data scope, response mapping and purchase-order prefill for purchase inquiries.
 * Write-side commands live in {@link PurchaseInquiryPostingService}; quote persistence lives in
 * {@link PurchaseInquiryQuoteService}. Sibling-accessible helpers ({@link #requireInquiry},
 * {@link #requireInquiryForUpdate}, {@link #loadLines}, {@link #toResponse}, {@link #toSummaryResponse})
 * are package-private so the posting service can reuse them within the inquiry transaction.
 */
@Service
public class PurchaseInquiryQueryService {
    ...
    PurchaseInquiryEntity requireInquiryForUpdate(Long id, AuditMetadata audit) {
    ...
    PurchaseInquiryResponse toSummaryResponse(PurchaseInquiryEntity entity) {
