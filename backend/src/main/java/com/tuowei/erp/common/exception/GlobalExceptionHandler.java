...
public class GlobalExceptionHandler {
    ...
    private static final Map<String, String> DUPLICATE_KEY_MESSAGES = Map.ofEntries(
            ...
            Map.entry("uk_pur_order_company_book_source_inquiry", "询价单已转换为采购订单"),
            Map.entry("uk_pur_inquiry_company_book_converted_order", "采购订单已关联询价单"),
            Map.entry("uk_pur_order_line_company_book_source_inquiry_line", "询价单明细已转换为采购订单明细"),
            Map.entry("uk_pur_inquiry_quote_line_company_book_quote_line", "报价明细不能重复提交询价行"),
