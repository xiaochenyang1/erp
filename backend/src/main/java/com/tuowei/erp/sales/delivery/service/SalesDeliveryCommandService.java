...
/** Write-side commands for sales delivery drafts and logistics updates. */
@Service
public class SalesDeliveryCommandService {
    ...
    private String normalizeLogisticsStatus(String status) {
        ...
        if (!Set.of("PENDING_SHIP", "PICKED_UP", "IN_TRANSIT", "DELIVERED").contains(upper)) {
    ...
    private void assertLogisticsTransition(String current, String next) {
        ...
        List<String> order = List.of("PENDING_SHIP", "PICKED_UP", "IN_TRANSIT", "DELIVERED");
