...
/**
 * Read-side configuration loading, response assembly and runtime approver resolution for workflows.
 */
@Service
public class WorkflowApprovalConfigQueryService {
    ...
    public WorkflowApprovalConfigQueryService(
    ...
    @Transactional(readOnly = true)
    public WorkflowApprovalConfigEntity findConfig(AuditMetadata audit, String businessType) {
    ...
    @Transactional(readOnly = true)
    public WorkflowApprovalConfigResponse toResponse(WorkflowApprovalConfigEntity config) {
        ...
        Map<Long, List<WorkflowApprovalNodeApproverEntity>> approversByNodeId = loadApproversByNodeId(
                config.getCompanyId(),
                nodes
        );
    ...
    public int normalizeTaskTimeoutHours(Integer taskTimeoutHours) {
    ...
    private List<Long> resolveConfiguredApproverUserIds(
        ...
        List<WorkflowApprovalNodeApproverEntity> approvers = approverMapper.selectList(
                new LambdaQueryWrapper<WorkflowApprovalNodeApproverEntity>()
    ...
    private List<Long> workflowViewerUserIds(Long companyId, Long accountBookId, Long submitUserId) {
        ...
        Map<Long, RoleEntity> roleById = activeRoles.stream()
