...
/** Write-side creation, editing, cancellation and purchase conversion for replenishment suggestions. */
@Service
public class InventoryReplenishmentSuggestionCommandService {
    ...
    public InventoryReplenishmentSuggestionCommandService(
