...
public class PaymentQueryService {
    ...
    private PaymentResponse toResponse(PaymentEntity payment, List<PaymentAllocationResponse> allocations) { return new PaymentResponse(payment.getId(), payment.getPaymentNo(), payment.getSupplierId(), payment.getPaymentDate(), payment.getAmount(), payment.getAllocatedAmount(), payment.getCurrencyCode(), payment.getExchangeRate(), payment.getBaseAmount(), payment.getStatus(), payment.getRemark(), payment.getCancelReason(), payment.getCancelledBy(), payment.getCancelledTime(), allocations); }
