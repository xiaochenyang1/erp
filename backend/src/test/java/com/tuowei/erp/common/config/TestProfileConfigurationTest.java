...
class TestProfileConfigurationTest {
    ...
    void testProfileUsesDedicatedTestDatabaseByDefault() throws IOException {
        ...
        assertThat(testProperties.getProperty("spring.datasource.url"))
                ...
                .isEqualTo("${ERP_TEST_DATASOURCE_URL:jdbc:mysql://localhost:3306/erp_codex_test?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai&characterEncoding=utf8&createDatabaseIfNotExist=true}");
