...
import com.tuowei.erp.purchase.returnorder.service.PurchaseReturnCommandService;
...
class PurchaseReturnServiceDecompositionTest {
    ...
    void facadeKeepsReadSideSecurityAndContextLookupsBehindQueryService() {
        assertThat(autowiredConstructorDependencies(PurchaseReturnService.class))
                .containsExactlyInAnyOrder(
                        PurchaseReturnQueryService.class,
                        PurchaseReturnCommandService.class,
                        PurchaseReturnPostingService.class
                )
                .doesNotContain(
        ...
        assertThat(constructorDependencies(PurchaseReturnCommandService.class))
                .contains(
                        PurchaseReturnMapper.class,
                        PurchaseReturnLineMapper.class,
                ...
                .doesNotContain(PurchaseReturnService.class, PurchaseReturnPostingService.class,
                        CurrentUserContext.class, DataScopeService.class, ScopedUserResolver.class,
