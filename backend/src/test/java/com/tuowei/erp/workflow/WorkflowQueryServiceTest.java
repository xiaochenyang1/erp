...
/**
 * Read-side unit tests for {@link WorkflowQueryService}. Mirrors the query-default behaviour previously
 * verified through the facade in {@code WorkflowServiceQueryDefaultsTest}; these now exercise the
 * decomposed query service directly.
 */
...
class WorkflowQueryServiceTest {
    ...
    void listTasksTreatsNullQueryAsDefaultPagination() {
        ...
        WorkflowQueryService queryService = queryService(taskMapper, mock(WorkflowRecordMapper.class));

        PageResponse<WorkflowTaskResponse> response = queryService.listTasks(null);
    ...
    void listRecordsTreatsNullQueryAsDefaultPagination() {
        ...
        WorkflowQueryService queryService = queryService(mock(WorkflowTaskMapper.class), recordMapper);

        PageResponse<WorkflowRecordResponse> response = queryService.listRecords(null);
    ...
    void listTasksCanFilterOnlyOverduePendingTasks() {
        ...
        queryService(taskMapper, mock(WorkflowRecordMapper.class)).listTasks(query);
    ...
    private static WorkflowQueryService queryService(WorkflowTaskMapper taskMapper, WorkflowRecordMapper recordMapper) {
