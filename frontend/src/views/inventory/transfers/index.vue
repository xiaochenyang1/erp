  ...
  <div class="inventory-transfers-container">
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column :label="$t('inventoryTransfers.actions')" width="360" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" @click="handleView(row)">
              {{ $t('inventoryTransfers.action.view') }}
            </el-button>
            <el-button v-if="canViewAttachments" link type="primary" @click="openAttachments(row.id, row.transferNo)">
    ...
    <DocumentAttachmentDialog
      ...
      business-type="INVENTORY_TRANSFER"
