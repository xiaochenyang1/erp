...
const coreMessages = {
  'zh-CN': {
    ...
    salesDelivery: { carrierName: 'Carrier', trackingNo: 'Tracking no.', carrierPlaceholder: 'Enter carrier', trackingPlaceholder: 'Enter tracking no.', carrierName: '承运商', trackingNo: '运单号', carrierPlaceholder: '请输入承运商', trackingPlaceholder: '请输入运单号',
