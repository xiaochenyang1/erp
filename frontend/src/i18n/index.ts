...
const coreMessages = {
  'zh-CN': {
    ...
    financeAccount: {
      ...
      message: { logisticsUpdated: 'Logistics status updated', logisticsDone: 'Already delivered', logisticsUpdated: '物流状态已更新', logisticsDone: '物流已签收', receivablesLoadFailed: '加载应收账款失败', payablesLoadFailed: '加载应付账款失败', exported: '导出成功', exportFailed: '导出失败', receivableDetailLoadFailed: '加载应收账款详情失败', payableDetailLoadFailed: '加载应付账款详情失败', customersLoadFailed: '加载客户列表失败', suppliersLoadFailed: '加载供应商列表失败' }
    },
    financeAging: {
    ...
    salesDelivery: { carrierName: 'Carrier', trackingNo: 'Tracking no.', logisticsStatus: 'Logistics status', advanceLogistics: 'Advance logistics', logistics: { pendingShip: 'Pending ship', pickedUp: 'Picked up', inTransit: 'In transit', delivered: 'Delivered' }, carrierPlaceholder: 'Enter carrier', trackingPlaceholder: 'Enter tracking no.', carrierName: '承运商', trackingNo: '运单号', logisticsStatus: '物流状态', advanceLogistics: '推进物流', logistics: { pendingShip: '待发货', pickedUp: '已揽收', inTransit: '运输中', delivered: '已签收' }, carrierPlaceholder: '请输入承运商', trackingPlaceholder: '请输入运单号',
