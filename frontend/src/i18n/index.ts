...
const coreMessages = {
  'zh-CN': {
    ...
    purchaseOrder: {
      title: '采购订单管理', subtitle: '管理采购订单全生命周期，优化供应链效率', totalOrders: '订单总数', pendingApproval: '待审核', approved: '已审核', orderNo: '订单编号', orderNoPlaceholder: '请输入订单编号', supplier: '供应商', selectSupplier: '请选择供应商', allSuppliers: '全部供应商', orderStatus: '订单状态', selectStatus: '请选择状态', orderDate: '订单日期', dateRangeSeparator: '至', startDate: '开始日期', endDate: '结束日期', create: '新增订单', expectedArrival: '预计到货', expectedArrivalDate: '预计到货日期', orderAmount: '订单金额', createdBy: '创建人', createdAt: '创建时间', actions: '操作', view: '查看', print: '打印', copy: '复制', edit: '编辑', submit: '提交', approve: '审核', reject: '驳回', unapprove: '反审核', close: '关闭', cancel: '取消', trace: '追踪',
